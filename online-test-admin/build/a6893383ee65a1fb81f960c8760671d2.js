  ...
  (function () {
    ...
    this.onUpdate = function () {
      ...
      parser.options.errorHandler = {
        fatalError: function fatalError(fullMsg, errorMessage, locator) {
          errors.push({
        ...
        error: function error(fullMsg, errorMessage, locator) {
          errors.push({
            row: locator.lineNumber,
            column: locator.columnNumber,
            text: errorMessage,
        ...
        warning: function warning(fullMsg, errorMessage, locator) {
          errors.push({
            row: locator.lineNumber,
            column: locator.columnNumber,
            text: errorMessage,
